...
public class RestRequestController {
	...
	public ResponseEntity<String> allRequest(HttpServletRequest httpRequest, @RequestBody(required = false) String reqBody) throws JsonParseException, JsonMappingException, IOException{
	...
	public ResponseEntity<String> getRequest(HttpServletRequest httpRequest) throws JsonParseException, JsonMappingException, IOException{
		System.out.println("resource url:" + httpRequest.getRequestURI()+" Method:"+httpRequest.getMethod());
